...
const rootDir = path.join(__dirname, '../../../../../bot');

//console.log("rootDir", rootDir);
const config = require(path.join(rootDir, 'assets/config.json'));
...
class Core {
  ...
  static supabase = require("./DatabaseManager");
      ...
      async function startSystem() {
        ...
        if (systemName) {
          ...
          try {
            ...
            let system = require(path.join(rootDir, `systems/${systemName}.js`));
